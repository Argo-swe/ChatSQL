...
_indexes_out_file_base_path = "/tmp/test_indexes"  # Redirect the base path to a safe location
...
def test_get_embeddings(txtai_index_manager):
    ...
    assert isinstance(embeddings, Embeddings), "get_embeddings should return an instance of Embeddings"
